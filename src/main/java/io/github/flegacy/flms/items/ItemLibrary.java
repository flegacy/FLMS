...
public class ItemLibrary {
    ...
    private final ItemStack jumpToFirstButton;
    private final ItemStack jumpToLastButton;
    ...
    public ItemLibrary(FLMS plugin) {
        ...
        AttributeModifier attackSpeedModifier = new AttributeModifier(flmsItemKey, 999,
        ...
        jumpToFirstButton = new ItemStackBuilder(Material.SPECTRAL_ARROW)
                .setDisplayName(TextConstants.FLMS_ORANGE + "<b><i>Jump to First -->")
                .setLore(TextConstants.FLMS_YELLOW + "<b>CLICK TO VIEW")
                .build();

        jumpToLastButton = new ItemStackBuilder(Material.SPECTRAL_ARROW)
                .setDisplayName(TextConstants.FLMS_ORANGE + "<b><i><-- Jump to Last")
                .setLore(TextConstants.FLMS_YELLOW + "<b>CLICK TO VIEW")
                .build();
    ...
    public ItemStack getJumpToFirstButton() {
        return jumpToFirstButton.clone();
    }

    public ItemStack getJumpToLastButton() {
        return jumpToLastButton.clone();
    }
