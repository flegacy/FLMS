...
class EffectArgumentType : CustomArgumentType.Converted<EffectType, String> {
    ...
    companion object {
        private val ERROR_INVALID_EFFECT_TYPE = DynamicCommandExceptionType { type ->
            MessageComponentSerializer.message().serialize(errPrefixed("'$type' isn't an effect type."))
        }
